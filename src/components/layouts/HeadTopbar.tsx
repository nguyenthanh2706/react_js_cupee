...
export function HeadTopbar() {
    ...
    const currentLangObj = listLanguage.find((item) => item.code === useLocale());
            ...
            <div className="flex justify-end h-8 text-xs">
                <nav className="flex items-center space-x-4 text-white">
                    ...
                    <div className="flex items-center space-x-2 text-[16px]">
                        <a href="#" aria-label="Facebook" className="hover:text-blue-400" target="_blank"
                           rel="noopener noreferrer">
                            <i className="pi pi-facebook "></i>
                        </a>
                        <a href="#" aria-label="Instagram" className="hover:text-blue-400" target="_blank"
                           rel="noopener noreferrer">
                            <i className="pi pi-instagram"></i>
                        </a>
                        <a href="#" aria-label="Twitter" className="hover:text-blue-400" target="_blank"
                           rel="noopener noreferrer">
